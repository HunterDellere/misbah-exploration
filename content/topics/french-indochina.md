...
slug: french-indochina
summary: Eighty years of French colonial rule built rubber plantations, rail lines, opium monopolies, a Latin-script Vietnamese alphabet, and a generation of Vietnamese-educated revolutionaries who would eventually drive the French out.
status: complete
featured: true
updated: 2026-05-10
tags: [vietnam, history, anthropology]
pillar: vietnam
order: 3
geo:
  lat: 21.03
  lng: 105.85
  place: Hanoi (colonial capital of Indochina)
  precision: city
era:
  start: 1858
  end: 1954
...
sources:
  - title: "The Penguin History of Modern Vietnam — Christopher Goscha"
    url: https://www.penguin.co.uk/books/180168/the-penguin-history-of-modern-vietnam-by-christopher-goscha/9780141017433
  - title: "Colonial Cambodia's 'Bad Frenchmen' — Gregor Muller"
    url: https://www.routledge.com/Colonial-Cambodias-Bad-Frenchmen/Muller/p/book/9780415544252
---
...
- **Rice**, especially from the Mekong delta, where the French expanded paddy land enormously by digging an extensive canal network. By the 1930s Cochinchina was one of the world's largest rice exporters, with most of the surplus shipped to France, Hong Kong, and the Philippines.
- **Rubber**, planted by French companies on plantations in the southern highlands and northern Mekong delta region. *Hévéa brasiliensis*, the Amazon rubber tree, was introduced in the 1890s, and by the 1930s Indochina was a major global rubber producer. The plantations were notorious for harsh labor conditions; French companies recruited workers from the densely populated north on long-term contracts that frequently amounted to indentured servitude.
- **Coal**, from mines in the Quảng Ninh region of northern Tonkin, exported through the port of Hải Phòng.
- **Coffee** in the central highlands — small acreage at the time, but the seed of what would become an enormous post-1986 industry.
- **Opium**, sold under a French government monopoly. The opium *Régie* — a colonial state-run trade in legal opium for sale to colonial subjects — was, at its peak in the 1920s, generating roughly 40% of total Indochinese government revenue. The system was deeply uncomfortable for French observers at the time and was eventually wound down in the 1940s, but for most of the colonial period the colonial state was financed in significant part by drug sales to the population it governed.
...
- The *quốc ngữ* writing system. Universal among Vietnamese speakers.
- The colonial-era infrastructure: the rail line, the bridges, the boulevards.
- French-derived loanwords in everyday Vietnamese: *xà phòng* (savon, soap), *cà phê* (café, coffee), *bơ* (beurre, butter), *ga* (gare, train station), *xích lô* (cyclo).
- The food: bánh mì (the Vietnamese sandwich on French baguette), Vietnamese coffee culture (descended from French coffee plantations), pâté and charcuterie traditions adapted into Vietnamese cuisine. We will return to all of this in essay 6.
- A particular bureaucratic style and an educational system that retained French structural features for decades after independence.
- The political idea, embedded in the constitutions of every successor state, that *Vietnam is one nation* — a claim that French colonial unification of north, center, and south actually helped create the modern conditions for, even as it intended the opposite.
