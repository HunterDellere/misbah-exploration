...
summary: The method that made anthropology a discipline rather than a literature — and the unresolved question of what it is, exactly, you are doing when you do it.
status: complete
updated: 2026-05-10
tags: [anthropology, science, history]
pillar: anthropology
order: 2
geo:
  lat: -8.6
  lng: 151.0
  place: Trobriand Islands, Papua New Guinea
  precision: region
era:
  start: 1915
  end: present
...
sources:
  - title: "Argonauts of the Western Pacific — Bronisław Malinowski"
    url: https://en.wikipedia.org/wiki/Argonauts_of_the_Western_Pacific
  - title: "A Diary in the Strict Sense of the Term — Malinowski (posthumous)"
    url: https://www.worldcat.org/title/diary-in-the-strict-sense-of-the-term/oclc/29403"
  - title: "Tristes Tropiques — Claude Lévi-Strauss"
    url: https://en.wikipedia.org/wiki/Tristes_Tropiques
---
